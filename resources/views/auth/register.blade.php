    ...
    <div class="mt-8 sm:mx-auto w-full md:w-1/2">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <form class="space-y-5 " method="POST" action="{{ route('register') }}">
                ...
                <div>
                    <x-input-label for="referral_code" class="block text-sm font-medium text-gray-700" :value="__('Kode Referral (opsional)')" />
                    <div class="mt-1">
                        <x-text-input id="referral_code" name="referral_code" type="text"
                            ...
                            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 uppercase focus:outline-none focus:ring-amber-500 focus:border-amber-500 sm:text-sm" />
                    </div>
                    <p class="mt-1 text-xs text-gray-500">Kosongkan jika tidak punya.</p>
                </div>
