...
@section('content')
    @include('backend.layout.breadcrumb', ['content' => 'Tambah Materi'])
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0">Tambah Materi Baru</h3>
                        </div>

                        <form action="{{ route('console.material.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="question_topic_id" id="question_topic_id" class="form-control @error('question_topic_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($topics as $topic)
                                            <option value="{{ $topic->id }}" {{ old('question_topic_id') == $topic->id ? 'selected' : '' }}>
                                    ...
                                    @enderror
                                    <small class="form-text text-muted">Hanya topik yang belum punya materi yang ditampilkan.</small>
                                </div>
