            ...
            <div class="max-w-4xl mx-auto p-6 sm:p-8 bg-amber-50 rounded-xl shadow-lg border border-gray-100 space-y-10">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-700 text-sm sm:text-base">
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">1</span>
                            <span>Jika status Anda masih <strong>"FREE"</strong>, maka Anda belum memiliki akses ke <strong>Tryout Premium</strong>.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">2</span>
                            <span>Anda tetap bisa mengikuti <strong>Latihan Tryout</strong> yang berstatus <strong>"FREE"</strong>.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">3</span>
                            <span>Tryout Free bisa diulang, namun belum tersedia pembahasan soal.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">4</span>
                            <span>Untuk akses soal &amp; pembahasan lengkap, silakan upgrade menjadi <span class="font-semibold text-amber-600">PESERTA PREMIUM</span>.</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-700 leading-relaxed text-sm sm:text-base text-justify">
                        Dengan membayar <span class="font-bold text-emerald-700">{{ $priceFormatted }}</span>, Anda turut berkontribusi untuk membantu biaya operasional platform, server hosting, dan pengembangan sistem.
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-700 text-sm sm:text-base">
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">1</span>
                            <span>Transfer <span class="font-bold text-emerald-700">{{ $priceFormatted }}</span> melalui sistem transfer/top up.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">2</span>
                        ...
                        <li class="flex items-start gap-3">
                            <span class="w-7 h-7 flex-shrink-0 flex items-center justify-center bg-amber-500 text-white font-bold rounded-full">5</span>
